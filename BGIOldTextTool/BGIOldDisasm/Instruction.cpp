...
string WINAPI GetString(PBYTE BufferStart, ULONG& Offset)
{
	...
	MultiByteToWideChar(IsShiftJISString((CHAR*)(BufferStart + Value), lstrlenA((CHAR*)(BufferStart + Value)))
		? 932 : 936, 0, (CHAR*)(BufferStart + Value), lstrlenA((CHAR*)(BufferStart + Value)), WideString, 1500);
